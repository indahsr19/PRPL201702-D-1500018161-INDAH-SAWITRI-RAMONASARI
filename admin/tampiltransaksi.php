...
?>
  ...
  <img src="aset/useric.png" alt="" class="circle"><i class="mdi-action-account-circle prefix"></i>
  </div></div>
  ...
  <table class="tabel" border="1px" align="center">
    ...
    <td>
      ...
      <a href="edittrans.php?idtransaksi=<?php echo $value['idtransaksi']?>"><button class="btn waves-effect waves- green darken-4">biaya tambahan</button></a>
