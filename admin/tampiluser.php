...
<script>
  $("document").ready(function(){
    ...
    <tr>
      ...
      <td><a href="deleteuser.php?id_user=<?php echo $value['id_user']?>"><button class="btn waves-effect waves- red darken-1">Hapus</button></a>
        <a href="edituser.php?id_user=<?php echo $value['id_user']?>"><button class="btn waves-effect waves- green darken-1">Edit</button></a></td>
    </tr>
    <?php endforeach ?>
    </table>
    </div>
  ...
  <div id="modal1" class="modal modal-fixed-footer"><form  role="form" name="register" method="post" onSubmit="return valregister()" action="terimauser.php">
    <div class="modal-content">
      ...
      <p><div class="col s7">
            ...
            <tr>
            <td>Masukan telepon</td>
            <td><input type="text" id="telepon" name="telepon"/></td>
            </tr></table>
            </div></p>
    </div>
