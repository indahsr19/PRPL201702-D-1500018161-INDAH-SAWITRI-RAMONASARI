...
<script>
  $("document").ready(function(){
    ...
    <tr>
      ...
      <td><a href="deleteadmin.php?idadmin=<?php echo $value['idadmin']?>"><button class="btn waves-effect waves- red darken-1">Hapus</button></a>
        <a href="editadmin.php?idadmin=<?php echo $value['idadmin']?>"><button class="btn waves-effect waves- green darken-1">Edit</button></a></td>
    </tr>
    <?php endforeach ?>
    </table>
      </div>
