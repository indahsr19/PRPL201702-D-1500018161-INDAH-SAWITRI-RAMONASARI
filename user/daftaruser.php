...
<div class="card-panel light-green darken-4">
  <h5 align="center" style="color: white"><b>hotelpass</b></h5>
  <h6 align="center" style="color: white"><i>Temukan halte dan lokasi wisata di sekitar Yogyakarta.. Membantu setiap perjalanan Anda</i></h6></div>
    ...
    <div class="utama">
      <form role="form" name="register" method="post" onSubmit="return valregister()" action="terimauser.php" >
        ...
        <div align="center"  class="row">
         ...
         <div align="center" class="row">
          <div class="input-field col s12 m4 center-on-small-only">
          <td><button class="btn waves-effect waves- light-green darken-4" type ="submit" value="submit" name="cek">daftar</button></td>
         </div></div>
  </form></div>
  </div>
</div>
